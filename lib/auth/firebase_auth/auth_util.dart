...
DocumentReference? get currentUserReference =>
    loggedIn ? AdminaccountsRecord.collection.doc(currentUser!.uid) : null;

AdminaccountsRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : AdminaccountsRecord.getDocument(
                  AdminaccountsRecord.collection.doc(uid))
              .handleError((_) {}),
    )
    .map((user) {
